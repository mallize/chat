 ...
 */
const findAtIndex = (0, _curry.default)((0, _defn.default)('findAtIndex', (fn, index, list) => {
  const length = list.length;
  let idx = index || 0; // TODO BRN: abstract this while loop pattern and make it reusable
