 ...
 */
const map = (0, _curry.default)((0, _defn.default)('map', (iteratee, collection) => (0, _reduce.default)((accum, value, kdx) => (0, _pipe.default)(() => iteratee(value, kdx), result => {
  accum[kdx] = result;
  return accum;
})(), (0, _isArrayLike.default)(collection) ? [] : {}, collection)));
var _default = map;
